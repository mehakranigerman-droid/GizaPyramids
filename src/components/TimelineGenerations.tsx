  ...
  return (
    <section id="generations" className="py-20 bg-[#EFE7DA] text-[#171513] border-b border-[#D8C7A3]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        {/* Interactive Succession Stepper Bar */}
            ...
            return (
              <button
                ...
                className={`p-3 text-left border transition-all cursor-pointer ${
                  isSelected
                    ? 'border-[#8A4F3D] bg-[#2B211B] text-[#F4EFE5] shadow-md'
                    : 'border-[#D8C7A3] bg-[#F4EFE5] text-[#2B211B] hover:bg-[#D8C7A3]/50'
                }`}
              >
                ...
                <h4 className="font-serif font-bold text-sm sm:text-base mt-1">
                  {gen.pharaoh}
                </h4>
                <p className={`text-[11px] font-mono mt-0.5 truncate ${isSelected ? 'text-[#D8C7A3]' : 'text-[#2B211B]/70'}`}>
                  {gen.location}
                </p>
              </button>
            );
        ...
        {/* Selected Generation Architectural & Historic Deep Dive */}
        <div className="bg-[#F4EFE5] border-2 border-[#B49A72] p-6 sm:p-8 shadow-md">
          <div className="flex flex-wrap items-start justify-between gap-4 border-b border-[#D8C7A3] pb-4 mb-6">
            <div>
              <div className="flex items-center gap-2">
                <span className="font-mono text-xs uppercase tracking-widest text-[#8A4F3D] font-bold">
                  Pharaonic Profile // {currentGen.reign}
                </span>
              </div>
              <h3 className="text-3xl font-serif font-bold text-[#2B211B] mt-1">
                {currentGen.pharaoh}
              </h3>
            ...
            <div className="text-left sm:text-right">
              <span className="font-mono text-xs text-[#2B211B] uppercase block">Primary Monument</span>
              <span className="font-serif text-lg font-bold text-[#2B211B] block">
                {currentGen.monument}
              </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-[#EFE7DA] p-5 border border-[#D8C7A3]">
              <h4 className="font-mono text-xs font-bold text-[#2B211B] uppercase tracking-wider mb-2 flex items-center gap-2">
          ...
          <div className="p-4 bg-[#2B211B] text-[#F4EFE5] border-l-4 border-[#8A4F3D] text-xs font-mono leading-relaxed">
            <span className="text-[#8A4F3D] font-bold uppercase tracking-wider block mb-1">
