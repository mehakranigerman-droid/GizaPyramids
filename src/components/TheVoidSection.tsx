  ...
  return (
    <section id="void" className="py-20 bg-[#2B211B] text-[#F4EFE5] border-b border-[#8A4F3D]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        {/* The Dual Epistemic Reality Card */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <div className="bg-[#171513] p-6 border-l-4 border-emerald-500">
            ...
            <h4 className="font-serif text-lg font-bold text-[#F4EFE5] mb-2">
          ...
          <div className="bg-[#171513] p-6 border-l-4 border-stone-500">
            <div className="flex items-center justify-between mb-2">
        ...
        {/* Interactive Cosmic Muon Radiography Simulator */}
        <div className="bg-[#171513] border-2 border-[#B49A72]/40 p-6 sm:p-8 mb-12">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`px-3 py-1.5 text-xs font-mono uppercase tracking-wider transition-colors cursor-pointer ${
                  simulationStep === 'cosmic' ? 'bg-[#8A4F3D] text-[#F4EFE5] font-bold' : 'bg-[#2B211B] text-[#D8C7A3]'
                }`}
              >
                1. Cosmic Flux
              </button>
              <button
                ...
                className={`px-3 py-1.5 text-xs font-mono uppercase tracking-wider transition-colors cursor-pointer ${
                  simulationStep === 'detector' ? 'bg-[#8A4F3D] text-[#F4EFE5] font-bold' : 'bg-[#2B211B] text-[#D8C7A3]'
                }`}
              >
              ...
              <button
                ...
                className={`px-3 py-1.5 text-xs font-mono uppercase tracking-wider transition-colors cursor-pointer ${
                  simulationStep === 'discovery' ? 'bg-[#8A4F3D] text-[#F4EFE5] font-bold' : 'bg-[#2B211B] text-[#D8C7A3]'
                }`}
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
            {/* SVG Visual Stage */}
            <div className="lg:col-span-7 bg-[#241B16] p-4 border border-[#B49A72]/30">
            ...
            {/* Explanation Details */}
            <div className="lg:col-span-5 space-y-3 text-xs font-mono text-[#D8C7A3] leading-relaxed">
              {simulationStep === 'cosmic' && (
                <div className="space-y-2 animate-fadeIn">
                  <h5 className="font-serif text-base font-bold text-[#F4EFE5]">
              ...
              {simulationStep === 'discovery' && (
                <div className="space-y-2 animate-fadeIn">
                  ...
                  <p className="bg-[#241B16] p-3 border-l-2 border-[#8A4F3D] text-[#F4EFE5]">
